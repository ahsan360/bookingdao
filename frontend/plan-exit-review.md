...
description: |
  ...
  architecture/code quality/tests/performance, ask opinionated question for more clearance and walks through issues interactively with opinionated recommendations.
allowed-tools:
  - Read
  - Grep
  - Glob
